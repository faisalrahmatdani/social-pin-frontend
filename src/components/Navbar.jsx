    ...
    <div className="flex gap-2 md:gap-5 w-full mt-5 pb-7">
      ...
      <div className="flex gap-3">
        <Link to={`user-profile/${user?._id}`} className="hidden md:block">
          <img src={user.image} alt="user-img" className="w-14 h-full rounded-full " />
        </Link>
        <Link to="create-pin" className="border-solid border-2 border-indigo-600 text-indigo-600 w-14 h-12 rounded-lg md:w-14 md:h-12 flex justify-center items-center">
          <IoMdAdd fontSize={25} />
        </Link>
      </div>
    </div>
